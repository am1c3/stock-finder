...
import { Filter, Filters, FilterLabel, FilterValue } from './styles'
...
const SinglePageFilters: React.FunctionComponent<Props> = (props) => {
    ...
    return (
        <Filters>
            ...
            <Filter>
                ...
                <FilterValue>
                    <Select
                        ...
                        options={Object.keys(GRAPH_COMPONENT_TYPE).map(key => GRAPH_COMPONENT_TYPE[key])}
                    />
                </FilterValue>
            </Filter>
                ...
                <Filter>
                    ...
                    <FilterValue>
                        <Select
                            ...
                            options={Object.keys(GRAPH_TYPE).map(key => GRAPH_TYPE[key])}
                        />
                    </FilterValue>
                </Filter>)}
            <Filter>
            ...
            {type !== STOCK_DATA_INTERVAL_TYPES.Intraday &&
                <>
                    <Filter>
